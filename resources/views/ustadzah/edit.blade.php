                        ...
                        <div class="card">
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="/ustadzah/update">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">Ijazah Akhir</label>
                                        <div class="col-md-9">  
                                            <input type="file" class="form-control" id="fname"
                                                placeholder="" name="ijazah">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2  text-end control-label col-form-label">SK Guru</label>
                                        <div class="col-md-9">  
                                            <input type="file" class="form-control" id="fname"
                                                placeholder="" name="sk">
                                        </div>
